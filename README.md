...
1. Скачайте из релиза (Releases: https://github.com/emelyagr/Eyecamera/releases/tag/v1.0.0) файлы . Исполняемого файла нет, т. к. он не подойдёт для Вашего пользования. Далее описана инструкция для создания исполняемого файла для Вас.
